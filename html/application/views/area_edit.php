            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">&nbsp&nbsp지역 수정</h4>
                    </div>
                        ...
                        <div class="card card-body">
                            ...
                            <form class="form-horizontal m-t-30" name="form1" method="post" action="">
								<div class="form-group">
                                    <label>지역명 <span class="help"> </span></label>
                                    <input type="text" class="form-control" placeholder="areaname" name="areaname" maxlength="20" value="<?=$row->areaname; ?>">
                                </div>
								<div align="center">
