                        ...
                        <div class="card card-body">
                            ...
                            <form class="form-horizontal m-t-30" name="form1" method="post" action="" enctype="multipart/form-data">
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="0000-00-00 형식으로 쓰세염" name="startday" value=""  >
                                </div>
								<div class="form-group">
                                    <label>비고 <span class="help"> </span></label>
                                    <input type="text" class="form-control" placeholder="bigo" name="bigo" value=""  >
                                </div>
