                        ...
                        <div class="card card-body">
                            ...
                            <form class="form-horizontal m-t-30" name="form1" method="post" action="">
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="0000-00-00" name="day" value=""  >
                                </div>

								<div class="form-group">
                                    <label>시작시간<span class="help"> </span></label>
                                    <input type="text" class="form-control" placeholder="" name="start" maxlength="20" value="">
                                </div>
								<div class="form-group">
                                    <label>종료시간<span class="help"> </span></label>
                                    <input type="text" class="form-control" placeholder="" name="end" maxlength="20" value="">
                                </div>
								<div align="center">
