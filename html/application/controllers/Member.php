<?
    class Member extends CI_Controller {       // Member클래스 선언
		...
		public function mylists()
        {
            ...
            $this->load->view("admin_header");                    // 상단출력(메뉴)
            $this->load->view("member_mylist",$data);           // member_mylist에 자료전달
            $this->load->view("admin_footer");                      // 하단 출력 
        }
		...
		public function del()
		{
			...
			redirect("/~team17/member/lists" . $text1 . $page);            // 목록화면으로 돌아가기
		}
		public function add()
		{
			...
			*/
			...
			if (!$_POST ) // 목록화면의 추가버튼 클릭한 경우
			{
			 ...
			 else              // 입력화면의 저장버튼 클릭한 경우
			 {
				...
				redirect("/~team17/member/lists/". $text1 .$page);    //   목록화면으로 이동.
			 }
		 }
